...
<body class="overflow-auto">
    <header class="h-auto">
        <div class="d-flex pt-5 pb-3">
            ...
            <div class="col-8 text-center font-weight-bold fs-20"><fmt:message key="message.admin14"/></div>
            <div class="col"></div>
        </div>
    </header>
    ...
    <div class="container">
        ...
        <div class="info-box">
            <%-- 나의 메뉴 리스트 --%>
            <div class="row">
                <div class="col-6 text-secondary text-left fs-16"><span>NOTICE</span></div>
                <div class="col-6 text-secondary text-right fs-16"><span id="notice_date"></span></div>
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $.ajax({
                url : "/vietnam/api/mbl_ADM_0005.jsp",
                type : 'POST',
                dataType : 'JSON',
                data : datas,
                    ...
                    console.log(response);
                        for(var i = 0; i < response.RESULT.length; i++) {
                            if(response.RESULT[i].NOTI_ID == NOTI_ID) {
