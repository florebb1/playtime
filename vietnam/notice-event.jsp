...
<body class="overflow-auto">
    <header class="h-auto">
        <div class="d-flex pt-5 pb-3">
            ...
            <div class="col-8 text-center font-weight-bold fs-20"><fmt:message key="message.admin27"/></div>
            <div class="col"></div>
        </div>
    </header>
    ...
    <div class="container">
        ...
        <div class="info-box">
            <%-- 나의 메뉴 리스트 --%>
            <div class="row">
                <div class="col-6 text-secondary text-left fs-16"><span>EVENT</span></div>
                <div class="col-6 text-secondary text-right fs-16"><span id="event_date"></span></div>
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $.ajax({
                url : "/vietnam/api/mbl_ADM_0002.jsp",
                type : 'POST',
                dataType : 'JSON',
                data : datas,
                    ...
                    console.log(response);
                        for(var i = 0; i < response.RESULT.length; i++) {
                            if(response.RESULT[i].EVENT_ID == EVENT_ID) {
                                ...
                                if(response.RESULT[0].EVENT_TAG_01 != "" && response.RESULT[0].EVENT_TAG_01 != null) {
                                    $("#tag1").text("#"+response.RESULT[0].EVENT_TAG_01);
                                }
                                if(response.RESULT[0].EVENT_TAG_02 != "" && response.RESULT[0].EVENT_TAG_02 != null) {
                                    $("#tag2").text("#"+response.RESULT[0].EVENT_TAG_02);
                                }
                                if(response.RESULT[0].EVENT_TAG_03 != "" && response.RESULT[0].EVENT_TAG_03 != null) {
