...
<body>
    ...
    <div class="container">
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/images/brand/art.jpg" class="d-block w-100">
                </div>
            </div>
        </div>
        <%-- 브랜드 설명 --%>
        <div class="info-box text-center fs-14 my-5">
            ...
            <div class="fs-25 font-weight-bold"><fmt:message key="message.brandArt1"/></div>
            <div class="my-4"><fmt:message key="message.brandArt2"/></div>
            <img src="/images/brand/art/art1.png" class="d-block w-100">
            <hr class="text-secondary my-4">
            <div class="font-weight-bold pb-4"><fmt:message key="message.brandInfo2"/></div>
            <img src="/images/brand/art/art2.png" class="d-block w-100">
        </div>
        <img src="/images/brand/art/art3.jpg" class="d-block w-100 my-">
    </div>
