...
<body>
    <header class="h-100">
        <div class="d-flex py-5">
            ...
            <div class="col-8 text-center font-weight-bold fs-20">PLAY</div>
            <div class="col"></div>
        </div>
    </header>
    ...
    <div class="container">
        ...
        <div class="info-box text-center fs-14 my-5">
            ...
            <div class="fs-25 font-weight-bold"><fmt:message key="message.brandPlay1"/></div>
            <div class="my-4"><fmt:message key="message.brandPlay2"/></div>
            <img src="/images/brand/play/play1.png" class="d-block w-100">
            <hr class="text-secondary my-4">
            <div class="font-weight-bold pb-4"><fmt:message key="message.brandInfo2"/></div>
            <img src="/images/brand/play/play2.png" class="d-block w-100">
        </div>
        <img src="/images/brand/play/play3.jpg" class="d-block w-100 my-">
    </div>
