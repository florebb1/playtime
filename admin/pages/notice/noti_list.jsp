...
<%@ include file="../../include/pta_top.jsp" %>
    ...
    <section class="content-header">
        <h1>
            <b><fmt:message key="message.admin1"/></b>
        </h1>
            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    ...
                    <div class="box-footer clearfix">
                        ...
                        <button class="btn btn-primary pull-right" type="button" onclick="document.location.href='noti_view.jsp'"><fmt:message key="message.admin13"/></button>
                    </div>
                </div>
                <!-- /.box -->
            </div>
...
<script type="text/javascript">
    ...
    function notiView(notiId) {
        location.href = "noti_view.jsp?notiId="+notiId;
    }
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                $.each(result,function(index, item){
                    ...
                    html += "<tr onclick='notiView("+item.NOTI_ID+")'>";
