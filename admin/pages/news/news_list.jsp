...
<%@ include file="../../include/pta_top.jsp" %>
    ...
    <section class="content-header">
        <h1>
            <b><fmt:message key="message.admin3"/></b>
        </h1>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tbody id="news_body" name="news_body"></tbody>
                        </table>
                    </div>
                    <!-- /.box-body -->
                    <div class="box-footer clearfix">
                        <div class="pull-left no-padding" id="page"></div>
                        <button class="btn btn-primary pull-right" type="button" onclick="document.location.href='news_view.jsp'"><fmt:message key="message.admin13"/></button>
                    </div>
                </div>
                <!-- /.box -->
            </div>
...
function newsView(newsId) {
    location.href = "news_view.jsp?newsId="+newsId;
}
    ...
    $.ajax({
        ...
        success : function(data) {
            ...
            $.each(result,function(index, item){
                ...
                html += "<tr onclick='newsView("+item.NEWS_ID+")'>";
                html += "   <td>"+item.NEWS_ID+"</td>";
