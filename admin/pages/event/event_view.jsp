...
<section class="content-header">
    <h1>
        <b><fmt:message key="message.admin27"/></b>
    </h1>
        ...
        <div class="box-body">
            <form role="form" id="Aform" name="Aform" method="post" enctype="multipart/form-data" onsubmit="return mySubmit()">
                ...
                <div class="form-group">
                    <label class="fa  fa-check-circle-o">&nbsp;<b><fmt:message key="message.admin28"/></b></label>
                    <input type="text" id="eventTitle" name="eventTitle" class="form-control" placeholder="Title">
                </div>
                <div class="form-group">
                    <label class="fa  fa-check-circle-o">&nbsp;<b><fmt:message key="message.admin16"/></b></label>
                    <div class="radio">
                        <label>
                            <% if(request.getParameter("eventId") != "" && request.getParameter("eventId") != null){ %>
                ...
                <div id="conts">
                    <div class="form-group">
                        <label class="fa  fa-check-circle-o">&nbsp;<b><fmt:message key="message.admin29"/></b></label>
                ...
                <div class="form-group">
                    <label class="fa  fa-check-circle-o">&nbsp;<b><fmt:message key="message.admin30"/></b></label>
                    <div class="radio">
                        <label>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="text" id="event_tag_01" name="event_tag_01" class="form-control" placeholder="# Hashtag - 01">
                    </div>
                    <div>
                        <input type="text" id="event_tag_02" name="event_tag_02" class="form-control" placeholder="# Hashtag - 02">
                    </div>
                    <div>
                        <input type="text" id="event_tag_03" name="event_tag_03" class="form-control" placeholder="# Hashtag - 03">
                    </div>
                </div>
                <div class="form-group" align="right">
                    <label>
                        <% if(request.getParameter("eventId") != "" && request.getParameter("eventId") != null){ %>
                            <%-- <button type="button" class="btn btn-block btn-default" onclick="eventModify()">수정</button> --%>
                            <button type="submit" class="btn btn-block btn-default" ><fmt:message key="message.admin25"/></button>
                        <% }else{ %>
                            <%-- <button type="button" class="btn btn-block btn-default" onclick="eventWrite()">등록</button> --%>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        // 이벤트 상세내용 출력
        $.ajax({
            url : "../../api/pta_event_view.jsp",
            type : 'POST',
            dataType : 'JSON',
            data : { eventId : getParam("eventId") },
            success : function(data) {
                ...
                $("#event_tag_01").val(result.EVENT_TAG_01);
                $("#event_tag_02").val(result.EVENT_TAG_02);
                $("#event_tag_03").val(result.EVENT_TAG_03);
    ...
    function mySubmit() {
        var eventTitleChk = $("#eventTitle").val();
        if(eventTitleChk == null || eventTitleChk == '') {
            alert("You must enter a event title!");
            $("#eventTitle").focus();
            return false;
        }

        if(getParam("eventId") == null || getParam("eventId") == "") {
        ...
        <% if(request.getParameter("eventId") != "" && request.getParameter("eventId") != null){ %>
            ...
            $("#eventId").val(eventId);
            $("#Aform").attr("action", "/admin/api/pta_event_modify.jsp");
        <% }else{ %>
            $("#Aform").attr("action", "/admin/api/pta_event_write.jsp");
        <% } %>
        return true;
    }
    ...
    function eventModify() {
        if(confirm("Do you want to edit the notice?") == true) {
            ...
            var datas = {
                ...
                linkUrl : $("#linkUrl").val(),
                event_tag_01 : $("#event_tag_01").val(),
                event_tag_02 : $("#event_tag_02").val(),
                event_tag_03 : $("#event_tag_03").val()
            };
            $.ajax({
                url : "/admin/api/pta_event_modify.jsp",
                type : 'POST',
                dataType : 'JSON',
                data : datas,
                success : function(data) {
    ...
    function eventWrite(){
        if(confirm("Do you want to register the notice?") == true) {
            ...
            $.ajax({
                url : "/admin/api/pta_event_write.jsp",
                type : 'POST',
                dataType : 'JSON',
                data : datas,
                success : function(data) {
